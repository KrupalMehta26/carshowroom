		    ...
		    <div class="menu-main">
			   <?php
                 if(isset($_SESSION['s_name']))
                 {
					 ...
					 echo '<li><a href="othercare.php">services</a></li>';
		   ...
		   <div class="box_wrapper"><h1>👉BMW👈</h1></div>
			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="grid_desc">
						<p class="title">BMW  M4</p>
					</div>
					<div class="Details">
				     <a href="bmw%20m4.php" title="BMW M4 " class="button">Details<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="grid_desc">
						<p class="title"> BMW X6</p>
					</div>
					<div class="Details">
				     <a href="bmw%20x6.php" title="BMW X6 " class="button">Details<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="grid_desc">
						<p class="title">BMW i8</p>
					</div>
					<div class="Details">
				     <a href="bmw%20i8.php" title="BMW I8 " class="button">Details<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="grid_desc">
						<p class="title">BMW M3</p>
					</div>
					<div class="Details">
				     <a href="bmw%20m3.phpphp" title="BMW M3 " class="button">Details<span></span></a></div>
				</div>
			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="bmw%20x3.php" title="BMW  X3" class="button">Details<span></span></a></div>
				</div>
